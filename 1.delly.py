...
print "Merge SV sites into a unified site list"
...
print "Genotype this merged SV site list across all samples."
for i in bam_list:
	sample=i.split('_dedup.bam')[0]
...
print "Merge all genotyped samples to get a single VCF/BCF using bcftools merge"
...
print "Apply the germline SV filter which requires at least 20 unrelated samples"
